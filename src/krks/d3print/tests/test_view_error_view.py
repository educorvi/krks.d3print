...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_error_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='error-view'
        )
        self.assertTrue(view.__name__ == 'error-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in error-view'
        # )

    def test_error_view_not_matching_interface(self):
