...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_druckerview_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='druckerview'
        )
        self.assertTrue(view.__name__ == 'druckerview')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in druckerview'
        # )

    def test_druckerview_not_matching_interface(self):
